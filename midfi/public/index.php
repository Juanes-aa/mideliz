...
<body class="flex flex-col min-h-screen font-poppins bg-gray-50 text-gray-800">
  ...
  <section id="menu" class="w-full py-12 sm:py-16 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div class="relative flex items-center">
        ...
        <button onclick="moveSlide(-1); resetAutoplay();" 
        ...
        <div class="overflow-hidden w-full">
          <div id="carousel" class="flex gap-3 sm:gap-4 transition-transform duration-500">
            ...
            $platos = [
              ...
              ["Tacos al Pastor", "Deliciosos tacos con carne marinada y piña fresca.", "assets/images/general/tacos.jpg"],
              ["Ceviche Peruano", "Fresco y cítrico, preparado con pescado del día y limón.", "assets/images/general/ceviche.jpg"],
            ...
            foreach ($platos as $plato): ?>
              <article class="menu-card bg-white rounded-lg overflow-hidden cursor-pointer flex-shrink-0 shadow-sm hover:shadow-md transition-all duration-300"
                data-card>
  ...
  window.addEventListener("load", () => {
   ...
   // === CARRUSEL RESPONSIVO CON AUTOPLAY ===
    ...
    if (carousel) {
      ...
      window.resetAutoplay = resetAutoplay;
