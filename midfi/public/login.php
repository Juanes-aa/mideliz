    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center">
      ...
      <ul class="hidden lg:flex items-center space-x-6 xl:space-x-8 text-base xl:text-lg">
        ...
        <?php if ($usuario_logueado): ?>
          <li><a href="contact.php" class="nav-link hover:text-red-600 transition">Contacto</a></li>
          <li class="relative">
      ...
      <div class="login-card bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10">
        ...
        <form method="POST" action="" class="space-y-4 sm:space-y-5">
          <div class="form-group">
            ...
            <input type="email" 
                   ...
                   required
                   class="w-full p-3 sm:p-3.5 text-sm sm:text-base border-2 border-gray-300 rounded-lg focus:border-red-600 outline-none transition-all duration-300">
          </div>
        ...
        <div class="mt-6 sm:mt-8 text-center">
          <p class="text-gray-600 text-xs sm:text-sm">
            ¿No tienes cuenta? 
            <a href="register.php" class="text-red-600 font-semibold hover:text-red-700 hover:underline transition">
              Regístrate aquí
            </a>
          </p>
        </div>
